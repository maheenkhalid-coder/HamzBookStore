  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="HAMZ BOOKSTORE" src="img/hamz3.png" style="width: 147px;margin: 0px;"></a>
        </div>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              ...
              <div class="col-md-3 col-lg-3" id="offer">
                  <a href="Product.php?value=Literature%20and%20Fiction">    <img class="img-responsive center-block" src="img/offers/1.png"></a>
